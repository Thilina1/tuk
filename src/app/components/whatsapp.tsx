...
export default function WhatsAppWidget({ phoneNumber }: WhatsAppWidgetProps) {
    ...
    useEffect(() => {
        ...
        window.addEventListener('touchmove', onTouchMove, options as any);
