  ...
  return (
    <div
      style={{
        ...
        right: isMobile ? "auto" : "calc(env(safe-area-inset-right, 0px) + 24px)",
        left: isMobile ? "50%" : "auto",
        transform: isMobile ? "translateX(-50%)" : "none",
        width: isMobile ? "calc(100vw - 32px)" : `${POPUP_WIDTH}px`,
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <h3 style={{ fontWeight: "bold", fontSize: "18px" }}>WhatsApp</h3>
        </div>
        <button
          onClick={onClose}
...
export default function WhatsAppWidget({ phoneNumber = "+94770063780" }) {
  ...
  const handleClick = () => {
    ...
    setIsOpen((prev) => {
      ...
      if (willBeOpen) setShowNotification(false);
      return willBeOpen;
    });
  };
      ...
      {isOpen ? (
        ...
        <div style={{ position: "relative" }}>
          <button
            ...
            className={`w-16 h-16 rounded-full bg-[#22c55e] hover:bg-[#16a34a] shadow-lg flex items-center justify-center transition-all duration-300 ${
