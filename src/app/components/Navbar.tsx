...
export default function Navbar() {
  ...
  const underlinePurple = "rgb(167, 139, 250)";   // #A78BFA
  const greenButtonStart = "rgb(72, 187, 120)";   // #48BB78
  const greenButtonEnd = "rgb(56, 161, 105)";     // #38A169
  const greenButtonHoverStart = "rgb(56, 161, 105)"; // #38A169
  const greenButtonHoverEnd = "rgb(47, 133, 90)"; // #2F855A
  const whiteColor = "rgb(255, 255, 255)";        // #FFFFFF
  const semiTransparentWhite = "rgba(255, 255, 255, 0.1)";
  ...
  return (
    <>
      ...
      >
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8 font-sans">
              ...
              <button
                ...
                className="ml-8 px-5 py-2 flex items-center gap-2 rounded-full text-lg font-semibold shadow-md transition-all duration-300 transform hover:scale-105"
                aria-label="Chat on WhatsApp"
                style={{
                  backgroundColor: greenButtonStart,
                  color: whiteColor,
        ...
        {mounted && isOpen && (
          <div
            className={`fixed inset-0 w-full h-full z-[9999] flex flex-col justify-between items-center py-8 px-6 font-sans bg-opacity-98 transition-all duration-500 ease-in-out transform ${
          ...
          >
            ...
            <button
              onClick={handleWhatsAppClick}
              className="w-full max-w-xs px-8 py-3 flex items-center justify-center gap-3 rounded-full text-lg font-semibold shadow-lg transition-all duration-300 transform hover:scale-105 mt-8"
              aria-label="Chat on WhatsApp"
              style={{
                backgroundColor: greenButtonStart,
                color: whiteColor,
