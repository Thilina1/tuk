...
export default function ArugamBay() {
  return (
    <main className="bg-white min-h-screen font-sans text-gray-800">
      {/* Hero */}
      <section className="relative py-12 px-4 text-center shadow-sm" style={{
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1.7fr_1fr] gap-8 py-12 px-4 md:px-8">
        ...
        <aside className="space-y-6">
          {/* Share */}
          <div className="rounded-2xl shadow p-6 text-center border border-sky-200" style={{
            background: "linear-gradient(to bottom right, #bae6fd, #e0f2fe, #7dd3fc)",
          }}>
          ...
          {/* Pro Tips */}
          <div className="rounded-xl shadow-sm p-6" style={{ backgroundColor: "#e0f2fe" }}>
            <h4 className="text-sm font-semibold text-gray-800 mb-2">
              🌟 Pro Tips
            </h4>
            <ul className="text-sm text-gray-700 space-y-1 list-disc pl-5">
              <li>
                <strong>Catch the early waves 🌊</strong> – The best surf is before 9 AM, with fewer crowds and smooth rides.
              </li>
              <li>
                <strong>Try roti & kottu 🌮</strong> – Don’t miss local beachside eateries for fresh, spicy Sri Lankan food.
              </li>
              <li>
                <strong>Explore by tuk tuk 🚙</strong> – Visit Peanut Farm, Whisky Point, and Panama Beach at your own pace.
              </li>
            </ul>
          </div>
        </aside>
