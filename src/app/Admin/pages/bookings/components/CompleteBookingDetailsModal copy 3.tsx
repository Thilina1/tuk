...
//   const [activeLocations, setActiveLocations] = useState<{ label: string; value: string; price: number }[]>([]);
...
//   { label: string; value: any; price: number }[]
// >([]);
...
//       if (!checked) {
//         handleChange("trainTransfer", null);
//       }
//     }}
...
//       }
//       onChange={(selected) =>
//         handleChange("trainTransfer", selected?.value || null)
//       }
//       isClearable
...
//     value={
//       (formValues as any).trainTransferAssignedPerson
//         ? activePersons.find((person) => person.value === (formValues as any).trainTransferAssignedPerson)
//         : null
//     }
...
//     options={activePersons}
//     value={
//       (formValues as any).holdBackAssignedPerson
//         ? activePersons.find((person) => person.value === (formValues as any).holdBackAssignedPerson)
//         : null
//     }
//     onChange={(selectedOption) => {
