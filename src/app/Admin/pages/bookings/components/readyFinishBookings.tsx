...
export default function ReadyFinishBookings({ bookings }: { bookings: BookingData[] }) {
  ...
  return (
    <div>
      {onBoardBookings.length === 0 ? (
        <p className="text-gray-600">No booking returns for today or tomorrow.</p>
      ) : (
        <div className="overflow-x-auto shadow rounded-lg">
          <table className="min-w-full bg-white text-sm text-gray-800">
            ...
            <tr>
              ...
              <th className="px-3 py-2 text-left">Hold Back Person</th>
